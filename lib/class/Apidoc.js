...
class Apidoc {
  ...
  * - apidoc: que contiene una cadena de texto con la documentación.
  * @return {String}
  */
...
* @param {Object} field Atributo
* @param {boolean} onlyType Indica si solo se devolverá el tipo o se incluirán algunos detalles más específicos.
* @return {String}
*/
